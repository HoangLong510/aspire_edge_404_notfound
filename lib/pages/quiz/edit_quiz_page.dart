...
class _EditQuizPageState extends State<EditQuizPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_notFound) {
      return _notFoundBody(context, primary);
    }

    return _formBody(context, primary);
  }
  ...
  Widget _notFoundBody(BuildContext context, Color primary) {
    return SingleChildScrollView(
      padding: const EdgeInsets.fromLTRB(20, 12, 20, 24),
      child: Center(
        child: ConstrainedBox(
  ...
  Widget _formBody(BuildContext context, Color primary) {
    return SingleChildScrollView(
      padding: const EdgeInsets.fromLTRB(20, 12, 20, 24),
      child: Center(
        child: ConstrainedBox(
  ...
  Widget _createdAtPill(Color primary) {
    return Align(
  ...
  Widget _tierDropdown(Color primary) {
    return Container(
