...
class _CareerAddPageState extends State<CareerAddPage> {
  ...
  void initState() {
    super.initState();
    final data = (widget.career?.data() as Map<String, dynamic>?) ?? {};
    ...
    _skillsController = TextEditingController(
      text: (data['Skills'] ?? '').toString(),
    );
    _salaryController = TextEditingController(
      text: (data['Salary_Range'] ?? '').toString(),
    );
    _eduController = TextEditingController(
      text: (data['Education_Path'] ?? '').toString(),
    );
  }
          ...
          final rightColumn = <Widget>[
            ...
            TextFormField(
              ...
              decoration: deco(
                ...
                hint: "e.g., B.Sc. in CS, online courses...",
